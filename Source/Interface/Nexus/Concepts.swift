...
class Concepts {
    ...
    static func glyphs(s: CGFloat) -> [GlyphView] {
        ...
        let blackHolesExpGlyph: ExplorerGlyph = ExplorerGlyph(explorer: Aexels.blackHolesExplorer, radius: 50*s+2*p, x: 320*s, y: 1410*s)
        ...
        cellularGlyph.link(to: speedOfLightGlyph)
        ...
        hyleGlyph.link(to: zenosArrowsGlyph)
