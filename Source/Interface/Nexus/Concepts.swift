...
class Concepts {
    ...
    static let floatingLeaf: Article = Article(key: "floatingLeaf", parent: gravity2)
    static let fourClocks : Article = Article(key: "fourClocks", parent: gravity2)
    ...
    static func glyphs(s: CGFloat) -> [GlyphView] {
        ...
        let gravity1Glyph: ArticleGlyph = ArticleGlyph(article: gravity1, radius: 104*s+2*p, x: 200*s, y: 680*s)
        ...
        let gravity2Glyph: ArticleGlyph = ArticleGlyph(article: gravity2, radius: 110*s+2*p, x: 300*s, y: 1400*s)
        ...
        let electromagnetismExpGlyph: ExplorerGlyph = ExplorerGlyph(explorer: Aexels.electromagnetismExplorer, radius: 50*s+2*p, x: 410*s, y: 1150*s)
        ...
        let floatingLeafGlyph: AsideGlyph = AsideGlyph(article: floatingLeaf, radius: 62*s, x: 430*s, y: 1362*s)
        let fourClocksGlyph: AsideGlyph = AsideGlyph(article: fourClocks, radius: 46*s+2*p, x: 416*s, y: 1520*s)
        ...
        gravity2Glyph.link(to: floatingLeafGlyph)
        gravity2Glyph.link(to: fourClocksGlyph)
