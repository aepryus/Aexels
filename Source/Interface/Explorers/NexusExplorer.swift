...
// UIViewController ================================================================================
    override func viewDidLoad() {
        ...
        let hyleGlyph: ArticleGlyph = ArticleGlyph(article: Article.hyle, radius: 70*s+2*p, x: 280*s, y: 860*s)
        ...
        let electromagnetismExpGlyph: ExplorerGlyph = ExplorerGlyph(explorer: Aexels.electromagnetismExplorer, radius: 50*s+2*p, x: 390*s, y: 1290*s)
