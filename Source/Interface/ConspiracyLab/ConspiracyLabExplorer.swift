//
//  ConspiracyLabExplorer.swift
//  Aexels
//
//  Stub Lab hanging off Conspiracy.  Placeholder UI — to be fleshed out.
//

import Acheron
import UIKit

class ConspiracyLabExplorer: Explorer {

    let notesTab: NotesTab = NotesTab(key: "conspiracyLab")

    init() { super.init(key: "conspiracyLab") }
