...
// Explorer ========================================================================================
	...
	override func layout375x667() {
		...
		aether = ContentLimbo(frame: CGRect(x: 5, y: 20, width: lw, height: lw), content: aetherView)
		aether.frame = CGRect(x: 5, y: 20, width: lw, height: lw)
		aether.renderPaths()
		aether.alpha = 0
