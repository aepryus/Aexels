...
This equation is not exotic, and the convergence is worth recording.  It is the standard hyperbolic replacement for Poisson, reached here from accelerant compressibility but reached independently in numerical astrophysics as a self-gravity solver for mesh hydrodynamics — Hirai, Nagakura, Okawa & Fujisawa, "Hyperbolic Self-Gravity Solver for Large Scale Hydrodynamical Simulations," *Phys. Rev. D* **93**, 083006 (2016), arXiv:1602.05700; refined into a damped (telegraph) variant by Maeda, Inoue & Inutsuka, "An improved dynamical Poisson equation solver for self-gravity," *MNRAS* **527**, 471 (2024), arXiv:2310.08030.  Hirai et al. state plainly that the equation "corresponds to the weak field limit of the Einstein equations in general relativity" — a standard-physics endorsement of the shape arrived at here by an unrelated route.

One caveat on borrowing their numerics: both papers tune the propagation speed to *suppress* retardation rather than to model it — Hirai by taking the signal speed well above the hydrodynamical characteristic speed so the solution converges back to instantaneous Poisson, Maeda by damping the wave outright (optimal damping coefficient ≈ 2.5).  Their motivation is parallel efficiency, not physics.  The solver engineering is therefore established and available; the undamped $c_g = c$ regime that would produce genuine retardation and radiation reaction is not what those codes were built for.
